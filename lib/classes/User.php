...
class User
{
        ...
        string $reg_date = null)
    {
        ...
        if (!empty($role)) {
            $this->role = (string) strtolower($role);
        }
    ...
    /**
     * Sets user's role address.
     * 
     * @param string The user's role
     */
    function set_role(string $role)
    {
        $this->role = clean_data($role);
    }

    /**
     * Create a user account.
     * 
     * @return bool false | true if the account was created successfully.
     */
     ...
     * Subscribe.
     * 
     * @return bool false | true if the user subsctiption was created successfully.
     */
    public function subcribe(): bool
    {
        // Include our connection file.
        include LIB_DIR .'conn.php';
